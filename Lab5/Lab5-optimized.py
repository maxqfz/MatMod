...
source_str = open('dostoevsky.txt', 'r', encoding='utf-8').read()
...
words_to_compare = ['Раскольников', 'Разумихин', 'Соня', 'вчера', 'руки']
...
print("\n")
show_relative('Соня', 'Раскольников', 'она')
show_relative('Раскольников', 'Соня', 'он')
...
n1 = 'он'
n2 = 'она'
ns = ['Раскольников', 'Разумихин', 'Соня', 'вчера', 'руки']
w1 = words_codes[n1]
w2 = words_codes[n2]
v1 = word2vec(B, w1)
v2 = word2vec(B, w2)
